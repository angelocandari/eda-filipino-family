...
```{r}
fies.savings$finance <- with(fies.savings,
                            ifelse(inc_sav_ratio < 0, "deficit",
                            ifelse(inc_sav_ratio > 0, "surplus", "deficit")))

fies.savings$finance <- factor(fies.savings$finance)
```

```{r}
ggplot(fies.savings, aes(finance,  fill = head_class)) +
  geom_bar() +
  facet_wrap(~head_class)
```
