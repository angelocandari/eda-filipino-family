...
```{r Reveiw_workerClass, message=FALSE, warning=FALSE, paged.print=TRUE}
fies.workers <- fies %>%
...
But this is not clear because we are mixing households that rely both salaries
and business with people who are soley relient on either their salaries or their
business.
